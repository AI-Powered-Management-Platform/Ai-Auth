...
pub mod risk_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn score(
            &mut self,
            request: impl tonic::IntoRequest<super::ScoreRequest>,
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/aiauth.risk.v1.RiskService/Score",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aiauth.risk.v1.RiskService", "Score"));
...
pub mod risk_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/aiauth.risk.v1.RiskService/Score" => {
                    ...
                    struct ScoreSvc<T: RiskService>(pub Arc<T>);
                    impl<T: RiskService> tonic::server::UnaryService<super::ScoreRequest>
                    for ScoreSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as RiskService>::score(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "aiauth.risk.v1.RiskService";
